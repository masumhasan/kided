...
import { HomeIcon, ObjectsIcon, StoryIcon, QuizIcon, MenuIcon, LightbulbIcon, MicIcon, RewardsIcon, EyeIcon, TreasureHuntIcon, ScienceIcon } from '../Icons/Icons';
...
export const BottomNav = ({ activeTab, onNav, t }: BottomNavProps) => {
  ...
  const itemLabels: { [key in Exclude<ActiveTab, 'Chat' | 'Rewards' | 'Story' | 'Homework' | 'Playground' | 'Learning Camp'>]: string } = {
    Home: t('nav.home'),
